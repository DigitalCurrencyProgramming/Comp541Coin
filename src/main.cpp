...
uint256 hashGenesisBlock("0x9951fbf88608339521ec5c89ffbd9f20afff6ff843cbbdca1019e2ecf00b9e66");
...
const string strMessageMagic = "comp541coin Signed Message:\n";
...
static const int64 nTargetTimespan = 1 * 24 * 60 * 60; // comp541coin: 1 days
static const int64 nTargetSpacing = 120; // comp541coin: 2 minute blocks
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal comp541coin miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "comp541coin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x9951fbf88608339521ec5c89ffbd9f20afff6ff843cbbdca1019e2ecf00b9e66");
    }
    ...
    if (mapBlockIndex.empty())
    {
        ...
        block.nVersion = 1;
        block.nTime    = 1450797137; //Main Net epochtime
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 806822;

        if (fTestNet)
        {
            block.nTime    = 1450797137; // Test Net epochtime
            block.nNonce   = 806822;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0xe7c88d35a00a6e74ae760090369a27342b1293a55971e4ffa70e432572b1584c"));
